...
MACRO_CONFIG_INT(SvScoreSpikeYELLOW, sv_score_spike_yellow, 9, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
...
MACRO_CONFIG_INT(SvScoreSpikeBLUE, sv_score_spike_blue, 5, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spikes")
...
MACRO_CONFIG_INT(SvScoreSpikeBLACK, sv_score_spike_black, 21, 0, 100, CFGFLAG_SERVER, "Points for grabbing into this spike")
